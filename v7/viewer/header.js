...
// (page() in server/ui_variant.py serves that src with a per-variant static
// prefix baked on — the literal path is omitted here on purpose: hardcoding
// it in a .js file is exactly the mistake tests/test_ui_variant.py exists to
// catch, since it would keep loading the DEFAULT variant's copy even when
// this page is running under ?ui=<the other one>.)
