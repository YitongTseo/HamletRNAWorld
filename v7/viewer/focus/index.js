...
// Smell lines default OFF now that the desire layer landed — ten dashed
// lines per word read as clutter next to the heatmap. 'o' brings them back
// for neuron-level debugging.
let smellsVisible = false;    // toggle with 'o' key
let desireVisible = true;     // desire heatmap + halo on by default; 'd' hides
