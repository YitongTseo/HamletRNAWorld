...
def test_openai_shift_by_one_renumber_recovered():
    ...
    (audit finding); the exact-shift remap must recover correct alignment."""
    ...
    try:
        ...
        # prompt index i's score (written under label i+1) must land on
        # prompt window i — emotional encodes the prompt index
